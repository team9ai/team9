...
| Event Category       | ChunkType    | SubType         | RetentionStrategy |
| -------------------- | ------------ | --------------- | ----------------- |
| USER_MESSAGE         | WORKING_FLOW | USER            | COMPRESSIBLE      |
| LLM_TEXT_RESPONSE    | AGENT        | -               | COMPRESSIBLE      |
| PARENT_AGENT_MESSAGE | DELEGATION   | -               | CRITICAL          |
| TOOL_CALL            | WORKFLOW     | -               | COMPRESSIBLE      |
| TOOL_RESULT          | WORKING_FLOW | ACTION_RESPONSE | COMPRESSIBLE      |
| THINKING             | WORKING_FLOW | THINKING        | DISPOSABLE        |

...
-- Rename foreign key constraints on resource_usage_logs (references renamed tables)
ALTER TABLE "resource_usage_logs" RENAME CONSTRAINT "resource_usage_logs_task_id_agent_task__tasks_id_fk" TO "resource_usage_logs_task_id_routine__routines_id_fk";--> statement-breakpoint
